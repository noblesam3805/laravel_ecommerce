        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/m_p_orders"><i class="zmdi zmdi-home"></i> pending</a></li>
                            ...
                            <table class="table table-hover product_item_list c_table theme-color mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-breakpoints="sm xs md">Mark Completed</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($cart as $carts)
                                    ...
                                    <?php $img = json_decode($carts->images) ?>
                                        ...
                                        <td>
                                            <form method="post" action="{{'/updatestatus/'.$carts->id}}">
                                            @csrf
