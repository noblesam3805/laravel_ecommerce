...
<aside id="leftsidebar" class="sidebar">
    <div class="navbar-brand">
        ...
        <a href="index.html"><img src="images/icons/logo.jpeg" width="85" alt="logo"><span class="m-l-10"></span></a>
    </div>
    <div class="menu">
        <ul class="list">
            <li>
            ...
            <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-shopping-cart"></i><span>Ecommerce</span></a>
                <ul class="ml-menu">
                    ...
                    <li><a href="/upload_product">Post Product</a></li>
                    <li><a href="/m_c_orders">My Completed Orders</a></li>
                    <li><a href="/m_p_orders">My Pending Orders</a></li>
                    <li><a href="/a_p_orders">All Pending Orders</a></li>
                    <li><a href="/a_c_orders">All Completed Orders</a></li>
                </ul>
            </li>
        <li><a href="/settings"><i class="zmdi zmdi-account"></i><span>Profile</span></a></li>
