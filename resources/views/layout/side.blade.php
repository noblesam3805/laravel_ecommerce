        ...
        <ul class="list">
            ...
            <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-shopping-cart"></i><span>Ecommerce</span></a>
                <ul class="ml-menu">
                    ...
                    <li><a href="/u_c_orders">My Completed Orders</a></li>
                    <li><a href="/u_p_orders">My Pending Orders</a></li>

                </ul>
            </li>
        <li><a href="/usettings"><i class="zmdi zmdi-account"></i><span>Profile</span></a></li>
